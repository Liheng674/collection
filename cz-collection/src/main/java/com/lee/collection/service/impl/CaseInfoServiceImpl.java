...
import com.lee.collection.mapper.CaseInfoMapper;
import com.lee.collection.service.CaseInfoService;
import com.lee.collection.util.ExcelRead;
import com.lee.collection.util.ExcelUtil;
...
public class CaseInfoServiceImpl implements CaseInfoService
{
	...
	public void leadInExcel(MultipartFile file)
	{
	    ...
	    // 插入到case_info表
	    caseInfoMapper.batchInsert(list_caseInfo);
	}

	@Override
	public List<CaseInfo> getAll()
	{
		return caseInfoMapper.getAll();
	}

	@Override
	public List<CaseInfo> selectInfosByBatchCode(String batchCode)
	{
		return caseInfoMapper.selectInfosByBatchCode(batchCode);
	}
